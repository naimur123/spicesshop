<?php
	...
	if (isset($_POST["submit"])) {
		...
		$to='support@spicesshop.com'; // Receiver Email ID, Replace with your email ID
		$subject='Spices Shop';
		$message="Name :".$name."\n"."Phone :".$phone."\n"."Wrote the following :"."\n".$message;
		$headers="From: ".$email;
  ...
  <div class="container">
	...
	<div class="row">
	  ...
	  <div class="col-md-6">
			...
			<h5 class="h5"><strong><span class="glyphicon glyphicon-map-marker" style="color:#F14F12"></span> Address: </strong>82, Shohid Faruk Sorok, South Jatrabari</h5>
			<h5 class="h5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;  </strong>Dhaka-1204,Bangladesh</h5>
			<h5 class="h5"><strong><span class="glyphicon glyphicon-envelope" style="color:#F14F12"></span>  Email: </strong> &nbsp; &nbsp;support@spicesshop.com</h5>
			<h5 class="h5"><strong><span class="glyphicon glyphicon-earphone" style="color:#F14F12"></span>  Contact: </strong>&nbsp;01977733240,01977733241</h5>
