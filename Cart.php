...
class Cart {
	...
	public function insert($item = array()){
		if(!is_array($item) OR count($item) === 0){
            ...
            if(!isset($item['id'], $item['name'], $item['prdname'], $item['price'], $item['unit'] , $item['qty'])){
                return FALSE;
            }else{
                /*
                 * Insert Item
	...
	protected function save_cart(){
		...
		//echo 	$value."xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx";				
		$this->cart_contents['cart_total'] =	$value;	
