...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-12" align="center" style="background-color:gray">
			<h4 class="h4" style="color:#fff">OTHERS ITEMS</h4>
		</div>
	</div>
    ...
    <div  class="list-group list-group-horizontal">    
		<?php
        //get rows query
        $query = $db->query("SELECT distinct products_name,name  FROM `products` WHERE `products_category`='Others' and status='1' order by id DESC LIMIT 6");
        if($query->num_rows > 0){ 
