...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-12" align="center" style="background-color:#EE3232">
			<h4 class="h4" style="color:#fff;font-family:Courier;">*HOT DEALS*</h4>
		</div>
	</div>
    ...
    <div  class="list-group list-group-horizontal">    
		<?php
        //get rows query
        $query = $db->query("SELECT distinct products_name,name FROM products where hot_deals='1' order by id DESC LIMIT 6");
        if($query->num_rows > 0){ 
