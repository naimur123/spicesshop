...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-12" align="center" style="background-color:gray">
			<h4 class="h4" style="color:#fff">SHOP ITEMS</h4>
		</div>
	</div>
    ...
    <div  class="list-group list-group-horizontal">    
		<?php
        //get rows query
        $query = $db->query("SELECT distinct products_name,name FROM products where status='1' ORDER BY products_name");
        if($query->num_rows > 0){ 
 ...
 <div class="item col-xs-6 col-sm-2" style="padding:5px" !important>
		...
		<?php $count_lp++ ?>
        <?php } }else{ ?>
			<p class="lead" style="color:red"><b>Shop Items Not Available!</b></p>
        <?php } ?>
