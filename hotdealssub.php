...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-12" align="center" style="background-color:gray">
			<h4 class="h4" style="color:#fff">HOT DEALS ITEMS</h4>
		</div>
	</div>
    ...
    <div  class="list-group list-group-horizontal">    
		<?php
        //get rows query
        $query = $db->query("SELECT distinct products_name,name FROM products where hot_deals='1' and status='1' ORDER BY products_name");
        if($query->num_rows > 0){ 
