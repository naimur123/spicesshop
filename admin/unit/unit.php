...
<html>
	...
	<body>
		...
		<div class="container-fluid">
			...
			<div class="row">
				<h2 class="h2" align="center"><b>Unit Show</b></h2>
			</div>
			...
			<div class="row">
				...
				<br />
				<div align="right">
					<button type="button" id="add_button" data-toggle="modal" data-target="#userModal" class="btn btn-info"><span class="glyphicon glyphicon-plus-sign"></span> Add New Unit</button>
				</div>
				<br />
