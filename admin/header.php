...
<head>
	<meta charset="utf-8">
	<title>Mosla Bazaar Admin</title>
...
<div class="container-fluid" style="height:70px;padding:0px" !important>
	...
	<div class="col-sm-12" align="center">  
		...
		<?php
					...
					Welcome To <p class="pv" style="color:#2E89EA;font-weight: bold" height="40px"><?php echo htmlspecialchars($_SESSION['email_name']); ?></p>&nbsp;&nbsp;
...
<nav class="navbar navbar-default navbar-custom" data-spy="affix" data-offset-top="197" style="width:100%">   
                ...
                <ul class="nav navbar-nav "> 
							...
							<li>
                				<a href="../sliding/sliding.php" style="color: #ffffff;">Sliding</a>							
                			</li>
							...
							<li>
                				<a href="../items/items.php" style="color: #ffffff;">Items</a>								
                			</li>
							...
							<li class="dropdown">
                				<a href="#" class="dropdown-toggle" data-toggle="dropdown" style="color: #ffffff;">Others<span class="caret"></span></a>	
									<ul class="dropdown-menu">
										...
										<li><a href="../district/district.php" style="color: #ffffff;">Customer District</a></li>
										<li><a href="../country/country.php" style="color: #ffffff;">Customer Country</a></li>
