...
<html>
	...
	<body>
		...
		<div class="container-fluid">
			...
			<div class="row">
				<h2 class="h2" align="center"><b>Sub Category Show</b></h2>
			</div>
			...
			<div class="row">
				...
				<br />
				<div align="right">
					<button type="button" id="add_button" data-toggle="modal" data-target="#userModal" class="btn btn-info"><span class="glyphicon glyphicon-plus-sign"></span> Add New Sub Category</button>
				</div>
				<br />
		...
		<form method="post" id="user_form" enctype="multipart/form-data">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<b style="color:red">***</b><label>Enter Item Sub Category</label>
...
$(document).ready(function(){
	...
	$(document).on('submit', '#user_form', function(event){
		...
		var subcatename = $('#subcatename').val();
		var catename = $('#catename').val();
		var remarks = $('#remarks').val();
		var active = $('#active').val();
		
		if(subcatename !='' && catename != '' && active != '')
		{
			$.ajax({
				url:"insert.php",
				method:'POST',
