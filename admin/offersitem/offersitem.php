...
<html>
	...
	<body>
		...
		<div class="container-fluid">
			...
			<div class="row">
				<h2 class="h2" align="center"><b>Offer Items Show</b></h2>
			</div>
			...
			<div class="row">
				...
				<div align="right">
					<button type="button" id="add_button" data-toggle="modal" data-target="#userModal" class="btn btn-info"><span class="glyphicon glyphicon-plus-sign"></span> Add Offer Items</button>
				</div>
				<br/>
		...
		<form method="post" id="user_form" enctype="multipart/form-data">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<br />
					<b style="color:red">***</b><label> Select Offer Item</label>
					...
					<br />
					<b style="color:red">***</b><label> Enter Offer Price</label>
					<input type="text" name="offprice" id="offprice" class="form-control" />
					<br />
					<label> Enter Offer Percentage</label>
...
$(document).ready(function(){
	$('#add_button').click(function(){
		$('#user_form')[0].reset();
		$('.modal-title').text("Add New Offer Item");
		$('#action').val("Add");
		$('#operation').val("Add");
